...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  <a class="navbar-brand custom-middle-font" href="${contextPath}">SHOPPING MALL</a>
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${!member.admin }">
								...
								<li class="nav-item"><a class="nav-link"
									href="${contextPath}/member/memberOrderList?page=1">주문배송 조회</a></li>
							</c:when>
							<c:otherwise>
								<li class="nav-item"><a class="nav-link"
								...
								<!-- <li class="nav-item"><a class="nav-link"href="${contextPath}/#">회원관리</a></li>-->
							</c:otherwise>
						</c:choose>
